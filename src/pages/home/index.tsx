            ...
            params: [
              {
                ...
                blockExplorerUrls: ['https://explorer.oychain.io'],
              },
            ],
          })
          .catch((error: any) => {
  ...
  return (
    <>
      ...
      <HomePageWrap>
        ...
        >
          <ColumnCenter>
            <TitleText>{t('Join The OYChain Community')}</TitleText>
            <BaseSubText>
              {t('OYChain  Community Title')}
              <br />
              {t(`Join OYChain Ttile`)}
            </BaseSubText>
