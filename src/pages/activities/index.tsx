...
const ActivitiesPage: React.FunctionComponent<GrantsPageProps> = () => {
  const activities: any[] = [
    ...
    },
    {
      ...
      url_ch: 'https://oychain.medium.com/kcc-ama-series-episode-1-whats-done-and-what-s-next-in-2021-4f50685a350c',
      url_en: 'https://oychain.medium.com/kcc-ama-series-episode-1-whats-done-and-what-s-next-in-2021-4f50685a350c',
    },
    // {
    ...
    //  deadline: '2021/08/09 10:57:33',
    //  url_ch: 'https://oychain.medium.com/kcc-ama-series-episode2-kuswap-safety-and-security-c642a46015f8',
    //  url_en: 'https://oychain.medium.com/kcc-ama-series-episode2-kuswap-safety-and-security-c642a46015f8',
    // }, 
//    {
...
//      url_ch: 'https://oychain.medium.com/kcc-ama-series-episode3-nfts-realm-nft-and-kcc-321d661d00f4',
//      url_en: 'https://oychain.medium.com/kcc-ama-series-episode3-nfts-realm-nft-and-kcc-321d661d00f4',
//    },
    {
      ...
      deadline: '2021/09/10 10:57:33',
      url_ch: 'https://oychain.medium.com/kcc-ama-series-episode4-paprprintr-stablecoin-and-kcc-63ce6c7401ce',
      url_en: 'https://oychain.medium.com/kcc-ama-series-episode4-paprprintr-stablecoin-and-kcc-63ce6c7401ce',
    },
//    {
...
//      deadline: '2021/09/10 10:57:33',
//      url_ch:
//        'https://oychain.medium.com/kcc-ama-series-episode-5-padd-finance-next-generation-launchpad-and-kcc-d4f432719a74',
//      url_en:
//        'https://oychain.medium.com/kcc-ama-series-episode-5-padd-finance-next-generation-launchpad-and-kcc-d4f432719a74',
//    },
    {
  ...
  return (
    <ActivitiesPageWrap>
      <Helmet>
        <title>OYchain Activities</title>
        <meta name="description" content="Join exciting OYchain activities, including hackathon, meet-up and more." />
      </Helmet>
      {/* banner */}
      <ContentWrap>
        <Title>{t(`OYchain Activity Center`)}</Title>
