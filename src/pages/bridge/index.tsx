...
const BridgePage: React.FunctionComponent<BridgePageProps> = ({ children }) => {
  ...
  return (
    <BridgeWrap>
      <Helmet>
        <title>OYchain Bridge - Link to Other Public Chains</title>
        <meta
          name="description"
          content="OYchain Bridge provides the most convenient cross-chain asset conversion service. You can easily link to other public chains."
        />
      </Helmet>
