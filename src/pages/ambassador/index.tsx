...
const AmbassadorPage: React.FunctionComponent<AmbassadorPageProps> = () => {
  ...
  return (
    <AmbassadorPageWrap>
      <Helmet>
        <title>OYchain GoDAO Ambassador Program</title>
        <meta
          name="description"
          content="OYchain is a high performance decentralized public smart chain. We aim to provide community users with faster, more convenient and low-cost experience."
        />
      </Helmet>
      {/* banner */}
      ...
      <GrantBannerWrap>
        <BannerContentWrap>
          ...
          >
            {t('OYchain DAO Ambassador Program')}
          </BannerTitle>
          <BannerDescription
            style={{ color: '#fff', maxWidth: '482px', fontSize: '16px', fontWeight: 400, lineHeight: '28px' }}
          >
            {t(
              'OYchain DAO Ambassadors are passionate enthusiasts who want to help increase community awareness and educate people about OYchain Community Chain. Ambassadors are responsible to help the community and lead activities to grow the ecosystem, including organizing and hosting AMAs, creating content such as videos and tutorials, translating content into different languages, and much more.'
            )}
          </BannerDescription>
        </BannerContentWrap>
      </GrantBannerWrap>
