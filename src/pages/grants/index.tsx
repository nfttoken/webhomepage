...
const GrantsPage: React.FunctionComponent<GrantsPageProps> = () => {
  ...
  return (
    <GrantsPageWrap>
      <Helmet>
        <title>OYchain Grant Program - Get Supports and Grants for Your Projects</title>
        <meta
          name="description"
      ...
      <GrantBannerWrap>
        <BannerContentWrap>
          ...
          <BannerDescription>
            {t(
              'In support of our mission, the OYchain Foundation grants program funds software development and research in the field of decentralized software protocols.'
            )}
          </BannerDescription>
          <ButtonText>
            <Button
        ...
        <BaseWrap style={{ paddingTop: isMobile ? '16px' : '120px', position: 'relative', zIndex: 3 }}>
          ...
          >
            ...
            >
              ...
              <ParagraphText style={{ marginTop: '10px', fontSize: isMobile ? '14px' : '20px' }}>
                {t(
                  `OYchain Foundation funds research projects that advance and explore protocols in the  Blockchain Technology Stack`
                )}
